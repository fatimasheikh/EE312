...
int main() {
  ...
  // My test 11, reverse int
  n1 = -1147483647;
  expected = 0;
  actual = reverseInt(n1);
  printf("My Test 11 reverse int: expected value: %d, actual value: %d\n", expected, actual);

  if(expected == actual)  printf("passed my test 11, reverse int\n");
  else printf("**** FAILED **** my test 11, reverse int\n");
